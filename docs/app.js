...
var _user$project$FictionalLanguage$hexaToCons = function (s) {
	var _p1 = s;
	switch (_p1) {
		case '0':
			return 'p';
...
var _user$project$FictionalLanguage$visualToHexa = function (s) {
	return A2(
		_elm_lang$core$String$join,
		' ',
		A2(
...
var _user$project$FictionalLanguage$hexaToVisual = function (s) {
	return A2(
		_elm_lang$core$String$join,
		'◌',
		A2(
...
var _user$project$FictionalLanguage$getOrDefaultArr = F2(
	function (index, arr) {
		return _elm_lang$core$String$trim(
			A2(
				_elm_lang$core$Maybe$withDefault,
				'???',
				A2(_elm_lang$core$Array$get, index, arr)));
	});
var _user$project$FictionalLanguage$arrayToTuple = function (arr) {
	return {
		ctor: '_Tuple2',
		_0: A2(_user$project$FictionalLanguage$getOrDefaultArr, 0, arr),
		_1: A2(_user$project$FictionalLanguage$getOrDefaultArr, 1, arr)
	};
};
var _user$project$FictionalLanguage$csvToTuple = function (line) {
	return _user$project$FictionalLanguage$arrayToTuple(
		_elm_lang$core$Array$fromList(
			A2(_elm_lang$core$String$split, ',', line)));
};
var _user$project$FictionalLanguage$wordList = A2(
	_elm_lang$core$List$map,
	_user$project$FictionalLanguage$csvToTuple,
	_elm_lang$core$String$lines(_user$project$FictionalWords$csvContent));
var _user$project$FictionalLanguage$swapWordList = A2(
	_elm_lang$core$List$map,
	function (t) {
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Tuple$second(t),
			_1: _elm_lang$core$Tuple$first(t)
		};
	},
	_user$project$FictionalLanguage$wordList);
var _user$project$FictionalLanguage$swapWordDict = _elm_lang$core$Dict$fromList(_user$project$FictionalLanguage$swapWordList);
var _user$project$FictionalLanguage$wordDict = _elm_lang$core$Dict$fromList(_user$project$FictionalLanguage$wordList);
var _user$project$FictionalLanguage$specialWordList = A2(
	_elm_lang$core$List$map,
	_user$project$FictionalLanguage$csvToTuple,
	_elm_lang$core$String$lines(_user$project$FictionalWords$csvSpecialWords));
var _user$project$FictionalLanguage$specialWordDict = _elm_lang$core$Dict$fromList(_user$project$FictionalLanguage$specialWordList);
var _user$project$FictionalLanguage$specialWord = function (index) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'',
		A2(_elm_lang$core$Dict$get, index, _user$project$FictionalLanguage$specialWordDict));
};
var _user$project$FictionalLanguage$hexaToConsOrVowel = function (tuple) {
	var _p2 = tuple;
	var $char = _p2._0;
	var isVowel = _p2._1;
	return isVowel ? _user$project$FictionalLanguage$hexaToVowels($char) : _user$project$FictionalLanguage$hexaToCons($char);
};
var _user$project$FictionalLanguage$isEven = function (n) {
	return _elm_lang$core$Native_Utils.eq(
		A2(_elm_lang$core$Basics_ops['%'], n, 2),
		0);
};
var _user$project$FictionalLanguage$zip = F2(
	function (xs, ys) {
		...
		if ((_p3._0.ctor === '::') && (_p3._1.ctor === '::')) {
			return {
				...
				_1: A2(_user$project$FictionalLanguage$zip, _p3._0._1, _p3._1._1)
			};
		} else {
			return {ctor: '[]'};
		}
	});
var _user$project$FictionalLanguage$wordToPhonetic = function (s) {
	var w = A2(_elm_lang$core$String$split, '', s);
	var evenWord = _user$project$FictionalLanguage$isEven(
	...
	var isVowel = A2(_elm_lang$core$List$map, _user$project$FictionalLanguage$isEven, index);
	var pairs = A2(_user$project$FictionalLanguage$zip, evenWord, isVowel);
	return A2(
		_elm_lang$core$String$join,
		'',
		A2(_elm_lang$core$List$map, _user$project$FictionalLanguage$hexaToConsOrVowel, pairs));
};
var _user$project$FictionalLanguage$composedToPhonetic = function (s) {
	return A2(_elm_lang$core$String$startsWith, 'A', s) ? A2(
		_elm_lang$core$Basics_ops['++'],
		'sɑː',
		_user$project$FictionalLanguage$wordToPhonetic(
		...
		A2(
			_elm_lang$core$List$map,
			_user$project$FictionalLanguage$wordToPhonetic,
			A2(_elm_lang$core$String$split, 'D', s))) : _user$project$FictionalLanguage$wordToPhonetic(s))));
};
var _user$project$FictionalLanguage$hexaToPhonetic = function (s) {
	return A2(
		_elm_lang$core$String$join,
		' ',
		A2(
			_elm_lang$core$List$map,
			_user$project$FictionalLanguage$composedToPhonetic,
			_elm_lang$core$String$words(s)));
};
var _user$project$FictionalLanguage$unknownHexa = '??';
var _user$project$FictionalLanguage$wordToEng = function (s) {
	var _p4 = s;
	switch (_p4.ctor) {
		case 'X':
			return A2(
				_elm_lang$core$String$join,
				'/',
				_user$project$FictionalLanguage$toEng(_p4._0));
		case 'C':
			return A2(
				_elm_lang$core$String$join,
				':',
		...
		case 'N':
			return A2(
				...
				_p4._0);
		case 'Unknown':
			return _user$project$FictionalLanguage$unknownHexa;
		default:
			return _p4._0;
	}
};
var _user$project$FictionalLanguage$toEng = function (s) {
	return A2(_elm_lang$core$List$map, _user$project$FictionalLanguage$wordToEng, s);
};
var _user$project$FictionalLanguage$wordToFieldModel = function (s) {
	var eng = _user$project$FictionalLanguage$wordToEng(s);
	var hintStyle = _user$project$FictionalLanguage$specialWord(eng);
	return {text: eng, style: 'a1', hint: hintStyle, hintStyle: hintStyle};
};
var _user$project$FictionalLanguage$toListFieldModel = function (s) {
	return A2(_elm_lang$core$List$map, _user$project$FictionalLanguage$wordToFieldModel, s);
};
var _user$project$FictionalLanguage$unknownWord = '????';
var _user$project$FictionalLanguage$getOrDefaultDict = F2(
	function (index, dict) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			_user$project$FictionalLanguage$unknownWord,
			A2(_elm_lang$core$Dict$get, index, dict));
	});
var _user$project$FictionalLanguage$wordToHexa = function (s) {
	var _p5 = s;
	switch (_p5.ctor) {
		case 'X':
			return A2(
				_elm_lang$core$String$join,
				'C',
				_user$project$FictionalLanguage$toHexa(_p5._0));
		case 'C':
			return A2(
				_elm_lang$core$String$join,
				'D',
		...
		case 'Unknown':
			return _user$project$FictionalLanguage$unknownHexa;
		default:
			return A2(_user$project$FictionalLanguage$getOrDefaultDict, _p5._0, _user$project$FictionalLanguage$wordDict);
	}
};
var _user$project$FictionalLanguage$toHexa = function (s) {
	return A2(_elm_lang$core$List$map, _user$project$FictionalLanguage$wordToHexa, s);
};
var _user$project$FictionalLanguage$FieldModel = F4(
	function (a, b, c, d) {
		return {text: a, style: b, hint: c, hintStyle: d};
	});
var _user$project$FictionalLanguage$W = function (a) {
	return {ctor: 'W', _0: a};
};
var _user$project$FictionalLanguage$C = function (a) {
	return {ctor: 'C', _0: a};
};
var _user$project$FictionalLanguage$X = function (a) {
	return {ctor: 'X', _0: a};
};
var _user$project$FictionalLanguage$N = function (a) {
	return {ctor: 'N', _0: a};
};
var _user$project$FictionalLanguage$Unknown = {ctor: 'Unknown'};
var _user$project$FictionalLanguage$engToWord = function (s) {
	return A2(_elm_lang$core$String$startsWith, '#', s) ? _user$project$FictionalLanguage$N(
		A2(_elm_lang$core$String$dropLeft, 1, s)) : (A2(_elm_lang$core$String$contains, '/', s) ? _user$project$FictionalLanguage$toComposedWordsX(
		A2(_elm_lang$core$String$split, '/', s)) : (A2(_elm_lang$core$String$contains, ':', s) ? _user$project$FictionalLanguage$toComposedWordsC(
		A2(_elm_lang$core$String$split, ':', s)) : (_elm_lang$core$Native_Utils.eq(s, _user$project$FictionalLanguage$unknownWord) ? _user$project$FictionalLanguage$Unknown : _user$project$FictionalLanguage$W(s))));
};
var _user$project$FictionalLanguage$toComposedWordsC = function (list) {
	return _user$project$FictionalLanguage$C(
		A2(_elm_lang$core$List$map, _user$project$FictionalLanguage$engToWord, list));
};
var _user$project$FictionalLanguage$toComposedWordsX = function (list) {
	return _user$project$FictionalLanguage$X(
		A2(_elm_lang$core$List$map, _user$project$FictionalLanguage$engToWord, list));
};
var _user$project$FictionalLanguage$engToHexa = function (s) {
	return A2(
		_elm_lang$core$String$join,
		' ',
		_user$project$FictionalLanguage$toHexa(
			A2(
				_elm_lang$core$List$map,
				_user$project$FictionalLanguage$engToWord,
				_elm_lang$core$String$words(s))));
};
var _user$project$FictionalLanguage$hexaToWord = function (s) {
	return A2(_elm_lang$core$String$startsWith, 'A', s) ? _user$project$FictionalLanguage$N(
		A2(_elm_lang$core$String$dropLeft, 1, s)) : (A2(_elm_lang$core$String$contains, 'C', s) ? _user$project$FictionalLanguage$toComposedHexaC(
		A2(_elm_lang$core$String$split, 'C', s)) : (A2(_elm_lang$core$String$contains, 'D', s) ? _user$project$FictionalLanguage$toComposedHexaD(
		A2(_elm_lang$core$String$split, 'D', s)) : (_elm_lang$core$Native_Utils.eq(s, _user$project$FictionalLanguage$unknownWord) ? _user$project$FictionalLanguage$Unknown : _user$project$FictionalLanguage$W(
		A2(_user$project$FictionalLanguage$getOrDefaultDict, s, _user$project$FictionalLanguage$swapWordDict)))));
};
var _user$project$FictionalLanguage$toComposedHexaC = function (list) {
	return _user$project$FictionalLanguage$X(
		A2(_elm_lang$core$List$map, _user$project$FictionalLanguage$hexaToWord, list));
};
var _user$project$FictionalLanguage$toComposedHexaD = function (list) {
	return _user$project$FictionalLanguage$C(
		A2(_elm_lang$core$List$map, _user$project$FictionalLanguage$hexaToWord, list));
};
var _user$project$FictionalLanguage$hexaToEng = function (s) {
	return A2(
		_elm_lang$core$String$join,
		' ',
		_user$project$FictionalLanguage$toEng(
			A2(
				_elm_lang$core$List$map,
				_user$project$FictionalLanguage$hexaToWord,
				_elm_lang$core$String$words(s))));
};
var _user$project$FictionalLanguage$hexaToListFieldModel = function (s) {
	return _user$project$FictionalLanguage$toListFieldModel(
		A2(
			_elm_lang$core$List$map,
			_user$project$FictionalLanguage$hexaToWord,
			_elm_lang$core$String$words(s)));
...
var _user$project$App$hexaToText = F2(
	function (fromEng, hexa) {
		return fromEng ? _user$project$FictionalLanguage$hexaToVisual(hexa) : _user$project$FictionalLanguage$hexaToEng(hexa);
	});
var _user$project$App$textToHexa = F2(
	function (fromEng, text) {
		return fromEng ? _user$project$FictionalLanguage$engToHexa(text) : _user$project$FictionalLanguage$visualToHexa(text);
	});
var _user$project$App$switchBox = F3(
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(name1),
						_1: {
							ctor: '::',
							_0: A2(
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text(name2),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$App$iCol = 'blue';
var _user$project$App$eCol = 'amber';
var _user$project$App$colorSection = function (fromEng) {
	return fromEng ? A2(
		_elm_lang$core$String$join,
		' ',
		{
			ctor: '::',
			_0: _user$project$App$eCol,
			_1: {
				ctor: '::',
				_0: 'lighten-2',
				_1: {ctor: '[]'}
...
var _user$project$App$colorInput = function (fromEng) {
	return fromEng ? A2(
		_elm_lang$core$String$join,
		' ',
		{
			ctor: '::',
			_0: 'materialize-textarea',
			_1: {
				ctor: '::',
				_0: _user$project$App$eCol,
				_1: {
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('col s11'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$h5,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class(
										_user$project$App$colorSection(meta.fromEng)),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('flow-text validate'),
										_1: {
											ctor: '::',
...
var _user$project$App$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'NewContent') {
			var _p1 = _p0._0;
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					text: _p1,
					hexa: A2(_user$project$App$textToHexa, model.fromEng, _p1)
				});
		} else {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					...
					text: A2(_user$project$App$hexaToText, model.fromEng, model.hexa)
				});
		}
	});
var _user$project$App$stylish = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'conjunction', _1: 'chip'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'verb-start', _1: 'chip'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'verb-end', _1: 'chip'},
				_1: {ctor: '[]'}
			}
		}
	});
var _user$project$App$asStyle = function (index) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'',
		A2(_elm_lang$core$Dict$get, index, _user$project$App$stylish));
};
var _user$project$App$tdText = function (fmodel) {
	return A2(
		_elm_lang$html$Html$td,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class(
				_user$project$App$asStyle(fmodel.style)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(fmodel.text),
			_1: {ctor: '[]'}
		});
};
var _user$project$App$columnInfo = function (list) {
	return A2(
		_elm_lang$html$Html$tr,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$App$tdText, list));
};
var _user$project$App$tdChip = function (fmodel) {
	return A2(
		_elm_lang$html$Html$td,
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class(
						_user$project$App$asStyle(fmodel.hintStyle)),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(fmodel.hint),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
};
var _user$project$App$columnChip = function (list) {
	return A2(
		_elm_lang$html$Html$tr,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$App$tdChip, list));
};
var _user$project$App$tableInfo = F2(
						...
						},
						{
							...
							_0: A2(
								_elm_lang$html$Html$h5,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class(
										_user$project$App$colorSection(model.fromEng)),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Structure'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _user$project$App$columnInfo(trModel),
												_1: {
													ctor: '::',
													_0: _user$project$App$columnChip(trModel),
													_1: {ctor: '[]'}
												}
											}),
										_1: {ctor: '[]'}
...
var _user$project$App$model = {text: '', hexa: '', fromEng: true};
var _user$project$App$Model = F3(
	function (a, b, c) {
		return {text: a, hexa: b, fromEng: c};
	});
var _user$project$App$Metadata = F3(
	function (a, b, c) {
		return {title: a, id: b, fromEng: c};
	});
var _user$project$App$ToggleLanguage = {ctor: 'ToggleLanguage'};
var _user$project$App$NewContent = function (a) {
	return {ctor: 'NewContent', _0: a};
};
var _user$project$App$view = function (model) {
	var asHexa = A2(_user$project$App$textToHexa, model.fromEng, model.text);
	var asVisual = _user$project$FictionalLanguage$hexaToVisual(asHexa);
	var asPhonetic = _user$project$FictionalLanguage$hexaToPhonetic(asHexa);
	var asEng = _user$project$FictionalLanguage$hexaToEng(asHexa);
	var asListFieldModel = _user$project$FictionalLanguage$hexaToListFieldModel(asHexa);
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('orange-text text-accent-4'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
							...
							},
							{
								...
								_0: A2(
									_elm_lang$html$Html$textarea,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class(
											_user$project$App$colorInput(model.fromEng)),
										_1: {
											ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: A3(_user$project$App$switchBox, _user$project$App$ToggleLanguage, 'English', 'Interandroid'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											asHexa,
											{title: 'Hexa', id: 'disabled', fromEng: model.fromEng}),
										_1: {
											ctor: '::',
											_0: A2(
												_user$project$App$area,
												asVisual,
												{title: 'Visual', id: 'disabled', fromEng: model.fromEng}),
											_1: {
												ctor: '::',
												_0: A2(
													_user$project$App$area,
													asPhonetic,
													{title: 'Phonetic', id: 'disabled', fromEng: model.fromEng}),
												_1: {
													ctor: '::',
													_0: A2(
														_user$project$App$area,
														asEng,
														{title: 'English', id: 'disabled', fromEng: model.fromEng}),
													_1: {
														ctor: '::',
														_0: A2(_user$project$App$tableInfo, model, asListFieldModel),
														_1: {ctor: '[]'}
													}
												}
											}
