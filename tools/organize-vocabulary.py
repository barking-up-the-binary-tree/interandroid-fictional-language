#!/usr/bin/env python
# TODO this is info only, delete once not useful anymore
from string import Template

az = {}
az["symbiosis"] = "predator/prey,symbiosis,parasitism,mutualism"
# az["terrain"] = "mountain,plain,valley,oasis,desert,swamp,forest,river,hill,canyon,ocean,openground"
...
def normalize(text):
    return text.strip().replace(' ', '_').lower().capitalize()

todoTemplate = Template('$name')
