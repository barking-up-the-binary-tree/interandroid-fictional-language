...
?all-noun = AllConcept:?concept AllWord:?basic-word
...
?all-determiner = Core:$core-determiner Distributive:$distributive-determiner Quantifier:$quantifier-determiner
...
$visual-2-noun = Drawing Painting Architecture
...
$integer-sequence-noun = AlgebraicNumbers ComputableNumbers ConstructibleNumbers EvenNumbers FibonacciNumbers IrrationalNumbers OddNumbers PerfectNumbers PrimeNumbers TranscendentalNumbers
...
$specif-this= This ThisAction ThisAnimal ThisApproach ThisCharacteristic ThisConcept ThisContext ThisPerson ThisPlace ThisReason ThisThing ThisTimeframe
...
$exchange = Barter
$what-to-do = Empire Monarchy Anarchy Patriarch Republic Theocracy Fossil Myth
